...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tags: Attribute.Component<'general.tag', true>;
    comments: Attribute.Relation<
      'api::blog.blog',
      'oneToMany',
      'api::comment.comment'
...
export interface ApiLikeLike extends Schema.CollectionType {
  ...
  attributes: {
    ...
    users_permissions_user: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    blog: Attribute.Relation<'api::like.like', 'manyToOne', 'api::blog.blog'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiShareShare extends Schema.CollectionType {
  ...
  attributes: {
    blog: Attribute.Relation<'api::share.share', 'manyToOne', 'api::blog.blog'>;
    user: Attribute.Relation<
      'api::share.share',
      'manyToMany',
      'plugin::users-permissions.user'
